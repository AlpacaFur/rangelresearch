        ...
        <div className="flex flex-col max-w-6xl">
          ...
          <div className="bg-white p-8 mb-8">
            ...
            <p className=" text-gray-purple w-84 bg-transparent">
              Si tiene alguna pregunta o desea ponerse en contacto con un miembro
              del equipo de investigación, envíenos un correo electrónico a{" "}
              <Link
              ...
              . Para comunicarse con el investigador principal del estudio, David
              Rangel, envíe un correo electrónico a{" "}
              <Link
